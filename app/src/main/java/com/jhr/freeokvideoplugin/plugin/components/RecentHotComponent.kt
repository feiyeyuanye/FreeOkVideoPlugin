...
/**
 * FileName: RecentHotComponent
 * Founder: Jiang Houren
 * Create Date: 2023/6/27 20:06
 * Profile: 近期热门
 */
class RecentHotComponent: ICustomPageDataComponent {
    ...
    override suspend fun getData(page: Int): List<BaseData>? {
        ...
        val li = document.select(".module-card-items")[1].select(".module-card-item")
        for (liE in li){
